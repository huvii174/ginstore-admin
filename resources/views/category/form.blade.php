<form class="forms-sample" method="POST">
    ...
    <div class="mb-3">
        <label for="exampleInputUsername1" class="form-label">Nổi bật</label>
        <select name="c_hot" class="form-control" id="">
            <option value="1" {{ ($category->c_hot ?? 0) == 1  ? "selected" : ""}}>Nổi bật</option>
            <option value="0" {{ ($category->c_hot ?? 0) == 0  ? "selected" : ""}}>Mặc định</option>
        </select>
    </div>
    <div class="mb-3">
